...
This version of this question type is compatible with Moodle 3.7+. There are
...
To install using git, type this command in the root of your Moodle install
    ...
    git clone -b MOODLE_37_STABLE git@github.com:ecampbell/moodle-qtype_gapselect.git question/type/gapselect
Then add question/type/gapselect to your git ignore.

Alternatively, download the zip from
    https://github.com/ecampbell/moodle-qtype_gapselect/zipball/MOODLE_37_STABLE
